...
subj_list = ['gyri_weight.pkl_1.0_zscore','gyri_weight.pkl_1.5_zscore','gyri_weight.pkl_2.0_zscore']
pdata = ['label'+"%d" % j for j in range(0,1)]

vtk_path = '/media/shawey/SSD8T/GyraSulci_Motor/Twin_Transformers/VisualizationInBroswer/CorePeriphery/'
